...
type CreativeCategory = "all" | "posters" | "banners";

type CreativeItem = {
  title: string;
  category: Exclude<CreativeCategory, "all">; // "posters" | "banners"
  img: string;
  tags?: string[];
};

const creatives: CreativeItem[] = [
  // ✅ POSTERS (replace with your images)
  {
    title: "Event Poster — Promo",
    category: "posters",
    img: "BREATH LONGER (4).png",
    tags: ["Poster", "Event"],
  },
  {
    title: "Product Poster — Launch",
    category: "posters",
    img: "BREATH LONGER (5).png",
    tags: ["Poster", "Product"],
  },
  {
    title: "Product Poster — Launch",
    category: "posters",
    img: "BREATH LONGER (8).png",
    tags: ["Poster", "Product"],
  },

  // ✅ BANNERS (replace with your images)
  {
    title: "Website Banner — Hero",
    category: "banners",
    img: "Aditya Enterprises.png",
    tags: ["Banner", "Hero"],
  },
  {
    title: "Sale Banner — Offer",
    category: "banners",
    img: "2.png",
    tags: ["Banner", "Sale"],
  },
...
const PostersBanners = () => {
  ...
  const grouped = useMemo(() => {
    const posters = creatives.filter((c) => c.category === "posters");
    const banners = creatives.filter((c) => c.category === "banners");
    return { posters, banners };
  }, []);
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <section className="relative bg-gradient-to-b from-[#F6C400] via-[#F6C400] to-black">
          ...
          <div className="mx-auto max-w-7xl px-6 pt-28 pb-16 sm:pt-32">
            ...
            <p className="mt-4 max-w-2xl text-sm sm:text-base text-black/80">
              Posters for promotions/events + banners for websites and marketing — organized section-wise.
            </p>

            {/* FILTERS */}
            <div className="mt-8 flex flex-wrap gap-3">
              <Tab id="all" label="All" />
              <Tab id="posters" label="Posters" />
              <Tab id="banners" label="Banners" />
            </div>
          </div>
        ...
        <section className="bg-black">
          <div className="mx-auto max-w-7xl px-6 py-16">
            {(active === "all" || active === "posters") && (
              <>
                <SectionHeader
                  title="Posters"
                  subtitle="Event promos, product launches, brand campaigns."
                />
                <CardGrid items={grouped.posters} onOpen={setOpen} />
              </>
            )}

            {active === "all" && <Divider />}

            {(active === "all" || active === "banners") && (
              <>
                <SectionHeader
                  title="Banners"
                  subtitle="Website hero banners, offer banners, ad banners."
                />
                <CardGrid items={grouped.banners} onOpen={setOpen} />
              </>
            )}
            ...
            <div className="mt-16 rounded-3xl border border-white/10 bg-white/5 p-8 sm:p-10">
              <h2 className="text-2xl sm:text-3xl font-semibold">
                Need posters or banners for your business?
              </h2>
              <p className="mt-2 text-white/70 max-w-2xl">
                I can design premium posters + banners that match your brand and convert better.
              </p>
            ...
            >
              <div className="flex items-center justify-between p-4 sm:p-5 border-b border-white/10">
                <div>
                  ...
                  <p className="text-xs text-white/60">{open.category.toUpperCase()}</p>
                </div>
                <button
                  onClick={() => setOpen(null)}
