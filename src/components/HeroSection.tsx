    ...
    <section id="home" className="relative w-full h-screen overflow-hidden flex flex-col font-sans bg-black">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center px-6 sm:px-12 md:px-20 max-w-6xl pb-20">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <a
            href="/Products"
            className="group inline-flex items-center gap-4 bg-[#fff] hover:bg-[#88ffed] text-black px-8 py-4 rounded-full font-bold text-xs tracking-[0.1em] uppercase transition-all duration-300"
          >
            Explore Products
