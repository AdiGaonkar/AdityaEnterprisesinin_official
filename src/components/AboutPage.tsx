        ...
        <div className="relative px-4 sm:px-10 md:px-16 py-20 flex flex-col-reverse md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left md:ml-32">
            ...
            <p className="text-base sm:text-lg text-gray-200 leading-relaxed">
              AE Techno Services was founded with a simple belief — that the right technology can solve real problems, create new opportunities, and help businesses move forward with confidence.
              <br />
              <br />
